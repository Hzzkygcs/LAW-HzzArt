...
const instanceNumberId = getRandomInt(999);
function getInstanceNumberId() {
    return instanceNumberId;
}
module.exports.getInstanceNumberId = getInstanceNumberId;
function getInstanceId(serviceName, ipAddress) {
    return `${serviceName}-${ipAddress}-${instanceNumberId}`
}
